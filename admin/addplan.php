					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Plan</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="planinsert.php">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Plan Name</label>
													<input type="text" id="" class="form-control" placeholder="Plan Name" name="pname" autocomplete="off">
													</div>
												</div>
												
												<div class="col-md-6">
													<div class="form-group">
														<label for="projectinput6">Plan Duration</label>
														<select class="select2-B form-control" multiple="multiple" name="duration">
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Enter The Price" name="price" autocomplete="off">
													</div>
												</div>									
