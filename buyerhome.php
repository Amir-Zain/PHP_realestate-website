...
<?php  
 ...
 $sql="SELECT DISTINCT place FROM product_tb";
 $result=mysqli_query($conn,$sql);
?>
<?php  
 include("dbconnection.php");
 $sql="SELECT DISTINCT ptype FROM product_tb";
    ...
    <div class="filter-search">
        <div class="container ">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <form class="filter-form" method="post" action="buyersearch.php">
                        <div class="location">
                            <p>location</p>
                            <select class="filter-location" name="search1">
                            <?php 
                        ...
                        <div class="search-type">
                            <p>Property Type</p>
                            <select class="filter-property" name="search2">
                            <?php 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-items">
                        ...
                        <div class="room-text">
                            ...
                            <?php echo"<a class='lg1'  href=confirm.php?id=".$row['id'].">Intersted</a>";?>
