 ...
 $result=$conn->query("SELECT * from user_tb where email='$a'");
 $row=$result->fetch_assoc();
{
 ...
 include("dbconnection.php");
 $id=$_GET['id'];
 $result=$conn->query("SELECT * from product_tb where id='$id'");
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="contact-form">
                        <h4>Get in Touch</h4>
                        <form method="post" action="confirminsert.php">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h6>Product Code:</h6>
                                    <input type="text" class="name" name="pcode" value="<?php echo $row['id'];?>" readonly>
                                </div><br>
                               ...
                               <div class="col-lg-12">
                                ...
                                <div class="col-lg-6">                                    
                                    ...
                                    <input type="text" name="name" value="<?php echo $a1;?>">
                                </div>
                               
                                <div class="col-lg-6">
                                    <input type="text" name="mobile" value="<?php echo $a2;?>">
                                </div>
                               
                                <div class="col-lg-6">
                                    <input type="email" name="email" value="<?php echo $a3;?>">
                                </div>
                                 
                                <div class="col-lg-6">
                                    <input type="text" name="place" value="<?php echo $a4;?>">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3">                                 
                                    ...
                                    <input type="submit" class="site-btn c-btn" name="submit" value="Confirm">
                                </div>
                            </div>
                        </form>
                    </div>
