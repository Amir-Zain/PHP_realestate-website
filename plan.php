        ...
        <div class="container">
            <form method="post" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="box"><h4 style="color: white"><?php echo $row['pname'];?></h4>
                                    Duration: <?php echo $row['duration'];?>
                                    Amount:<?php echo $row['price'];?><?php echo "<br>";
                                     echo" <button class='bt' ><a href=signup.php?id=".$row['id']." >Choose your Plan  </a></button>";
